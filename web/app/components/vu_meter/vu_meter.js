...
angular.module("keenaudio").directive("kVuMeter", function($http, $routeParams) {
  return {
    restrict: 'A',
    scope: {
      gainNode: '='
    ...
    link:function ($scope, $elem, attr) {
      ...
      var canvas = $elem.children().first()[0];
      ...
      function setupAudioNodes(gainNode) {

          var ac = gainNode.context;
